...
int32_t comp32(register uint32_t, register uint32_t);
uint32_t *sync_find(register uint32_t *);
int32_t addr_corr(register uint32_t);
int32_t num_proc(register int32_t, register uint32_t);
int32_t alpha_proc(register int32_t, register uint32_t);
int32_t msg_proc(register uint32_t *);
int main(void);
uint32_t hexword, parity;
int32_t error_code;
char s1, s3;
static char alpha[] =
{
...
uint32_t err_corr(register uint32_t datain)
{
...
int32_t comp32(register uint32_t sample, register uint32_t reference)
{
  int32_t i, num_err;
...
uint32_t *sync_find(register uint32_t *dptr)
{
  int32_t num_err;
  int32_t sync_window = 18;
  int32_t bit_cnt;
...
int32_t addr_corr(register uint32_t data)
{
  int32_t num_err;
  uint32_t addr;
  uint32_t capcode = 0x2a74e;
  addr = data >> 13;
...
int32_t num_proc(register int32_t i, register uint32_t codeword)
{
  int32_t count = 5;
  int32_t shift = 0;
  unsigned char digit;
...
int32_t alpha_proc(register int32_t i, register uint32_t codeword)
{
  int32_t num_bits_left;
  unsigned char rem_bits;
  int32_t char_count = 3;
  int32_t char_shift = 0;
  if (alpha_count > 0)
    {
...
int32_t msg_proc(register uint32_t *dptr)
{
  int32_t i = 0;
  int32_t word_count = 0;
  int32_t num_bad_sync = 0;
  int32_t num_err;
  int32_t addr_search_mode = 1;
  uint32_t addr;
  uint32_t data;
  while (1)
    {
